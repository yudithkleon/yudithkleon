...
🎯 Apasionada por construir interfaces escalables, accesibles y centradas en el usuario  
🧪 Experiencia combinando desarrollo con **calidad, testing y performance**

Trabajo con metodologías ágiles, pensamiento de producto y atención al detalle.
### 💡 Especialidades
- Desarrollo Frontend moderno (React + TypeScript)
- Arquitectura de interfaces escalables
- Integración Frontend–Backend (APIs REST)
- Testing funcional y E2E (Cypress)
- UX/UI con enfoque en usabilidad real
...
![Redux Saga](https://img.shields.io/badge/Redux_Saga-999999?style=for-the-badge&logo=redux-saga)
...
![TOGAF](https://img.shields.io/badge/TOGAF-4B0082?style=for-the-badge)
